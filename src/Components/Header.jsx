  ...
  return (
    <header className='pb-4 flex flex-col'>
      <div className=' flex justify-between items-center'>
        <img className='w-4 object-fill aspect-square' src="/small_logo.png" alt="brand image" />
      ...
      <nav className='grid grid-cols-1 lg:grid-cols-3 gap-3'>
        <Link href={"/"}><img className='mx-auto lg:m-0 w-4 object-fill aspect-square' src="/logo.png" alt="" /></Link>
